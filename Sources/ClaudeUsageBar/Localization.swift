...
struct L10n {
    private static let strings: [AppLanguage: [String: String]] = [
        .ko: [
            ...
            // Info tab labels
            "settings.info.name": "이름",
            "settings.info.email": "이메일",
            "settings.info.plan": "플랜",
            "settings.info.model": "모델",
            "settings.info.login": "로그인",
            "settings.info.version": "버전",
            "settings.info.timezone": "타임존",
            "settings.info.region": "지역",
            "settings.info.org": "조직",
            "settings.info.noData": "-",
            "settings.info.checkUpdate": "업데이트 확인",
            "settings.update.checking": "확인 중...",
            "settings.update.available": "새 버전 v%@ 사용 가능",
            "settings.update.upToDate": "최신 버전입니다",
            "settings.update.error": "업데이트 확인 실패",
            "settings.update.newVersion": "새 버전이 있습니다",
            "settings.update.newVersionDetail": "v%@ 버전을 사용할 수 있습니다. (현재: v%@)",
            ...
            "settings.display.fiveHour": "현재 세션 사용률",
            "settings.display.sevenDay": "주간 사용률",
            "settings.display.opus": "Opus 사용률",
            "settings.display.sonnet": "Sonnet 사용률",
            "settings.display.coloredStatusBar": "상태바 색상 표시",
            "settings.display.stats": "로컬 통계",
            "settings.statusBar": "상태바 표시",
            "settings.statusBar.fiveHourAndWeekly": "현재 세션 + 주간",
            "settings.statusBar.fiveHourOnly": "현재 세션만",
        ...
        .en: [
            ...
            // Usage (menu format)
            "usage.fiveHour": "Session Usage: %.1f%%",
            ...
            "settings.info.plan": "Plan",
            "settings.info.model": "Model",
            "settings.info.login": "Login",
            "settings.info.version": "Version",
            "settings.info.timezone": "Timezone",
            "settings.info.region": "Region",
            "settings.info.org": "Org",
            "settings.info.noData": "-",
            "settings.info.checkUpdate": "Check for Updates",
            "settings.update.checking": "Checking...",
            "settings.update.available": "New version v%@ available",
            "settings.update.upToDate": "You're up to date",
            "settings.update.error": "Update check failed",
            "settings.update.newVersion": "New Version Available",
            "settings.update.newVersionDetail": "v%@ is available. (Current: v%@)",
            ...
            "settings.display.fiveHour": "Session Usage",
            "settings.display.sevenDay": "Weekly Usage",
            "settings.display.opus": "Opus Usage",
            "settings.display.sonnet": "Sonnet Usage",
            "settings.display.coloredStatusBar": "Colored Status Bar",
            "settings.display.stats": "Local Stats",
            "settings.statusBar": "Status Bar",
            "settings.statusBar.fiveHourAndWeekly": "Session + Weekly",
            "settings.statusBar.fiveHourOnly": "Session Only",
